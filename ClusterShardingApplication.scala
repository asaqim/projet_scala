...
import TemperatureActor.{GetCurrentTemperature, Location, UpdateTemperature}
...
object ClusterShardingApplication extends App {
  ...
  //Let's simulate some time has passed. Never use
  //Thread.sleep in production!
  Thread.sleep(3000)

  val locations = Vector(Location("USA","Chicago"),
    Location("ESP", "Madrid"),Location("FIN", "Helsinki"))
